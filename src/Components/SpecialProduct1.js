...
function SpecialProduct1() {
  return (
    <div className='col-4'>
     <div className='special-product-card filter-card-div-3'>
     <div className='d-flex justify-content-between'>
        <div>
            <img src='images/ipad5.jpg' alt='watch' className='spe' />
        </div>
        <div className='special-product-content'>
            <h5>Samsung</h5>
            <h6 className='title'>
            boAt Rockerz 400 Bluetooth On Ear Headphones With Mic With Upto 8 Hours Playback... 
            </h6>
            <ReactStars
         count={5}
         size={24}
...
export default SpecialProduct1;
