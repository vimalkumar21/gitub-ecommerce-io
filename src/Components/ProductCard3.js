...
import ipad11 from './images/ipad11.jpg';
 ...
 <div className={`${location.pathname === "/store" ? `col-${grid}` : "col-3"} pb-3  gr`}> 
  ...
  <Link to='product/:id' className='product-card position-relative text-dark filter-card-div-3'>
   <Link className='product-image '>
    ...
    <img src={ipad11} alt='jnvsj' className='m1 img-fluid' />
   </Link>
   <div className='product-details'>
       <h6 className='brand '>zebronics</h6>
       <h5 className='product-title d-flex'>boAt Rockerz 400 Bluetooth With Mic With Upto 8 Hours Playback </h5>
